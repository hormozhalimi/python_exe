...
new_prices = [price_changed-5 for price_changed in prices]

print (new_prices)

total_counts=0

for last_week_counts in last_week:
  total_counts += last_week_counts

total_revenue= total_counts*total_price
